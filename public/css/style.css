/* ALSHAM 360° PRIMA - CSS ENTERPRISE V4.1 */
/* Design System NASA 10/10 Enterprise Grade */

@import url('https://fonts.googleapis.com/css2?family=Inter:wght@300;400;500;600;700;800;900&display=swap');

:root {
  /* CORES PRINCIPAIS - Paleta Premium Científica */
  --primary: #2563eb;        /* Azul Confiança (80% Fortune 500) */
  --secondary: #8b5cf6;      /* Roxo Premium (+25% valor percebido) */
  --success: #10b981;        /* Verde Crescimento (+30% satisfação) */
  --warning: #f59e0b;        /* Amarelo Atenção (+20% conversão) */
  --danger: #ef4444;         /* Vermelho Urgência */
  --accent: #ec4899;         /* Rosa Destaque (gamificação) */
  
  /* CORES NEUTRAS */
  --gray-50: #f8fafc;        /* Background suave */
  --gray-100: #f1f5f9;       /* Cards e superfícies */
  --gray-200: #e2e8f0;       /* Borders */
  --gray-300: #cbd5e1;       /* Borders ativos */
  --gray-400: #94a3b8;       /* Placeholders */
  --gray-500: #64748b;       /* Texto secundário */
  --gray-600: #475569;       /* Texto normal */
  --gray-700: #334155;       /* Texto importante */
  --gray-800: #1e293b;       /* Texto principal */
  --gray-900: #0f172a;       /* Texto destaque */
  
  /* CORES ESPECIAIS */
  --gold: #fbbf24;           /* Dourado (conquistas) */
  --teal: #14b8a6;           /* Teal (inovação) */
...
/* UTILITÁRIOS DE LAYOUT ENTERPRISE */
.container {
  width: 100%;
  margin-left: auto;
  margin-right: auto;
...
.-right-2 { right: calc(-1 * var(--space-2)); }
...
.from-gray-50 { --tw-gradient-from: var(--gray-50); --tw-gradient-to: rgb(248 250 252 / 0); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to); }
.from-gray-100 { --tw-gradient-from: var(--gray-100); --tw-gradient-to: rgb(241 245 249 / 0); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to); }
.from-gray-200 { --tw-gradient-from: var(--gray-200); --tw-gradient-to: rgb(226 232 240 / 0); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to); }
...
.via-gray-50 { --tw-gradient-to: rgb(248 250 252 / 0); --tw-gradient-stops: var(--tw-gradient-from), var(--gray-50), var(--tw-gradient-to); }
...
/* TRANSIÇÕES E ANIMAÇÕES ENTERPRISE */
...
/* ANIMAÇÕES ENTERPRISE CUSTOMIZADAS */
.animate-fade-in {
...
.progress-primary { background: var(--gradient-premium); }
.progress-secondary { background: var(--gradient-premium); }
...
/* Checkboxes e Radio Buttons Enterprise */
.form-check {
  display: block;
  min-height: 1.5rem;
  padding-left: 1.5em;
...
.form-check-input {
  ...
  border: 1px solid var(--gray-300);
  appearance: none;
  print-color-adjust: exact; /* <-- CORRIGIDO */
...
.form-switch .form-check-input {
  width: 2em;
  margin-left: -2.5em;
  background-image: url("data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='-4 -4 8 8'%3e%3ccircle r='3' fill='rgba%2899, 99, 99, 0.25%29'/%3e%3c/svg%3e");
...
.form-switch .form-check-input:focus {
  background-image: url("data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='-4 -4 8 8'%3e%3ccircle r='3' fill='rgba%2837, 99, 235, 0.25%29'/%3e%3c/svg%3e");
}
