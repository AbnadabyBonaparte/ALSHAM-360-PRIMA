/**
 * ALSHAM 360° PRIMA - LEADS REAIS V5.8.2
 * Sistema completo de gerenciamento de leads com IA e gamificação
 * ✅ CORRIGIDO: Event listeners CSP compliance + Score IA funcional
 */
...
waitForSupabase(() => {
  ...
  function renderCharts() {
    ...
    leadsState.charts.dailyChart = new Chart(dailyCanvas.getContext("2d"), {
      type: "line",
      data: { labels: days, datasets: [{ label: "Novos Leads", data: counts, borderColor: "#3B82F6", backgroundColor: "rgba(59, 130, 246, 0.1)", fill: true, tension: 0.3 }] },
  ...
  window.recalculateLeadScore = async function(leadId) {
    try {
      ...
      const response = await fetch('https://rgvnbtuqtsvfxhrdnkjs.supabase.co/functions/v1/calculate-lead-score', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': `Bearer ${session.access_token}`,
          'apikey': 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InJndm5idHVxdHN2ZnhocmRua2pzIiwicm9sZSI6ImFub24iLCJpYXQiOjE3Mjc4OTU2ODQsImV4cCI6MjA0MzQ3MTY4NH0.sb_publishable_4GXjFzIqbEtaLwAu-ZNFA_BxkNHSIGp'
        },
  ...
  console.log("Leads-Real.js v5.8.2 carregado");
});
