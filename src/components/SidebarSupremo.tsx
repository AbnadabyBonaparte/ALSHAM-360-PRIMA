        ...
        <AnimatePresence mode="wait">
          {showLabels && (
            <motion.div
              ...
              transition={{ duration: 0.2 }}
            >
              <p className="text-[0.625rem] sm:text-xs uppercase tracking-[0.4em] text-[var(--color-primary-from)] font-semibold">
                ALSHAM
              </p>
                      ...
                      >
                        <span
                          className={`text-sm font-semibold ${
                            hasActiveLink ? 'text-[var(--color-primary-from)]' : 'text-[var(--text-primary)]'
                          }`}
                        >
                          {category.label}
                        </span>
          ...
          >
            ...
            >
              ...
              <div>
                ...
                <p className="text-[11px] text-[var(--text-secondary)]">IA Generativa Integrada</p>
              </div>
            </motion.div>
          </motion.div>
        )}
          ...
          >
            ...
            <div className="flex items-center justify-between border-b border-[var(--border)]/50 px-5 py-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-[0.625rem] sm:text-xs uppercase tracking-[0.35em] text-[var(--color-primary-from)] font-semibold">
                    ALSHAM
                  </p>
