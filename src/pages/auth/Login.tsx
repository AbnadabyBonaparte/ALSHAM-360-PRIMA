      ...
      <div className="max-w-md w-full bg-white rounded-xl shadow-lg p-8">
        ...
        <div className="mt-6">
          <button
            ...
            className="w-full bg-white border border-gray-300 text-gray-700 py-3 px-4 rounded-lg font-medium hover:bg-gray-50 focus:ring-2 focus:ring-gray-300 focus:ring-offset-2 flex items-center justify-center"
          >
