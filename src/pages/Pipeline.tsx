      ...
      >
        ...
        <div className="relative z-10">
          <div className="flex justify-between items-start mb-3">
            <div>
              <p className="text-xs text-white/50 uppercase">{deal.company}</p>
              <h3 className="font-black text-white text-lg">{deal.name}</h3>
            </div>
          ...
          <div className="flex items-center justify-between text-sm">
            <span className="text-white/60">{deal.probability}% chance</span>
            <span className="text-white/40">{daysOld}d</span>
          </div>
